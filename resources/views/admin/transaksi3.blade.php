            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <!-- <h4  class="bg-white" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Order
                    </h4> -->
                                ...
                                <table class="table bg-white rounded shadow-sm  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <span class="badge badge-warning">dijual kembali</span>
                                            @else
                                        ...
                                        <form action="/admin/transaksi" method="POST" enctype="multipart/form-data">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="">
                                                    <button type="submit" class="btn btn-warning" onclick="return confirm ('terima pesanan?')">Konfirmasi</button>
                                                    <div class="mb-1"></div>
                                                    <a href="/admin/transaksi/hapus/{{ $p->id }}" class="btn btn-danger" onclick="return confirm ('apa kamu yakin?')" data-target="" data-toggle="">Batalkan</a>
                                                </div>
                                                @else
