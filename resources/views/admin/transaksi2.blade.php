                            ...
                            <div class="col">
                                <table class="table bg-white rounded shadow-sm  table-hover">
                                    ...
                                    <tr style="font-size: 14px;">
                                        ...
                                        <td class="text-center"> @if ($p->status == 'selesai')
                                        ...
                                        <form action="/admin/transaksi" method="POST" enctype="multipart/form-data">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="mb-1"></div>
                                                    <a href="/admin/transaksi2/hapus/{{ $p->id }}" class="btn btn-danger col-12" onclick="return confirm ('apa kamu yakin?')" data-target="" data-toggle="">Batalkan</a>
                                                </div>
