                            ...
                            <div class="table-responsive">
                                <table class="table bg-white rounded shadow-sm  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="/user/user_transaksi2/hapus/{{ $p->id }}" class="btn btn-danger" onclick="return confirm ('apa kamu yakin?')" data-target="" data-toggle="">cancel</a></td>
