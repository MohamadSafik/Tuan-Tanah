                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5 mb-3">
                                            <div class="card-body">
                                                ...
                                                <form action="/user/user_create_profile" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="col-30">
                                                        <label class="form-label @error('no_hp') is-invalid @enderror"  for="no_hp">No Telp/Hp</label>
                                                        <input type="text" id="no_hp" class="form-control" value=" {{ Auth::user()->no_hp }}" name="no_hp">
                                                    ...
                                                    <div class="col-30 mb-3">
                                                        ...
                                                        <input type="text" id="alamat" class="form-control" value="{{ Auth::user()->alamat }}" name="alamat">
                                                        <div class="invalid-feedback">
                                                            isi alamat anda!
                                                        </div>
                                                    </div>
                                                    <div class="col-30 mb-3">
                                                        <label class="form-label @error('no_rek') is-invalid @enderror"  for="no_rek">No Rek ( bank + nomor rekening)</label>
                                                        <input type="text" id="no_rek" class="form-control" value="{{ Auth::user()->no_rek }}" name="no_rek">
                                                        <div class="invalid-feedback">
                                                            isi alamat anda!
                                                        </div>
                                                    </div>
                                                    <div class="col-30">
                                                        ...
                                                        <input type="file" id="image" class="form-control" value="{{ Auth::user()->image }}" name="image">
                                                        <div class="invalid-feedback">
                                                            isi foto anda!
                                                        </div>
                                                    </div>
