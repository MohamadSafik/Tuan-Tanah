                                ...
                                <table class="table bg-white rounded shadow-sm  table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($p->status == 'selesai')
                                            <span class="badge badge-success col-9">selesai</span>
                                            @elseif ($p->status == 'menunggu konfirmasi')
                                            <span class="badge badge-warning col-9">menunggu konfirmasi</span>
                                            @elseif ($p->status == 'dijual kembali')
                                            <span class="badge badge-secondary col-9">dijual kembali</span>
                                            @else
                                            <span class="badge badge-danger col-9">belum dibayar</span>
                                            @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="/user/user_transaksi2/hapus/{{ $p->id }}" class="btn btn-danger col-8" onclick="return confirm ('apa kamu yakin?')" data-target="" data-toggle="">cancel</a></td>
                                        @else
                                        @endif
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn btn-warning col-12" data-bs-toggle="modal" data-bs-target="#exampleModal{{$key+1}}">
                                                Konfirmasi
                                            </button>
                                            <div class="mb-1"></div>
                                            <a href="/user/user_transaksi/hapus/{{ $p->id }}" class="btn btn-danger col-12" data-target="" data-toggle="">cancel</a>
                                            <!-- Modal -->
